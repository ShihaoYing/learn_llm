...
def extracted_data(pages_data):
    template = """Extract all the following values : Invoice ID, DESCRIPTION, Issue Date, 
        ...
        Expected output remove any dollar symbols ($) : {{'Invoice ID': '1001329','DESCRIPTION': 'UNIT PRICE': 1,'AMOUNT': 2,'Date': '5/4/2023','AMOUNT': '1100.00', 'Bill For': 'james', 'From': 'excel company', 'Terms': 'pay this now'}}
        """
